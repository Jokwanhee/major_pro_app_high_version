...
import com.goni99.designpro.databinding.ActivityMainBinding
import com.goni99.designpro.service.GPS
import com.goni99.designpro.view.ClosetActivity
import com.goni99.designpro.view.DryingActivity
import com.goni99.designpro.view.WashingMachineActivity
import com.goni99.designpro.viewModel.MainViewModel
    ...
    fun intentActivity() {
        with(binding) {
            ...
            dryingButton.setOnClickListener {
                val intent = Intent(baseContext, DryingActivity::class.java)
                startActivity(intent)
            }
